...
Que bom que você resolveu contribuir conosco. Obrigado! A proposta do APP NINJA é
...
Se encontrou um bug no APP NINJA você pode reportá-lo usando a ferramenta de
[issues do GitHub](https://github.com/midianinja/AppNinja/issues). Porém antes
...
[criar uma nova issue](https://github.com/midianinja/AppNinja/issues/new). No
...
`midianinja@gmail.com`. Ele será analisado, validado e corrigido de
...
Outra ótima forma de contribuir é indicando melhorias ao código do APP NINJA e em
...
2. Também verifique se a ideia já não está pressente em nossas
   [issues do GitHub](https://github.com/midianinja/AppNinja/issues);
...
[criar uma nova issue](https://github.com/midianinja/AppNinja/issues/new)
...
2. O recurso resolve um problema real validado por pessoas que estão em contato
   direto com a utilização da plataforma: membros midia ninja, frente hacker midia ninja, colaboradores e apoiadores.

Para criar seu pedido de recurso basta
[criar uma nova issue](https://github.com/midianinja/AppNinja/issues/new) usando
o label **recurso**.
...
contribuir com código. Para isso faça um fork do APP NINJA e trabalhe em cima de
...
compatibilidade com os padrões sendo adotados serão fechados. Para
entender melhor sobre esta decisão veja
[esta discussão](https://github.com/rails/rails/pull/13771#issuecomment-32746700).

### Outras formas de contribuir

Se você não trabalha com código mas quer ajudar o APP NINJA, existem muitas outras
...
para `midianinja@gmail.com` e conte sua história.
